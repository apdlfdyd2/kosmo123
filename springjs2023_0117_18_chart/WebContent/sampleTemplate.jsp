    ...
    <nav class="navbar navbar-expand-sm mybgColor" >
     <div class="container-fluid" >
        <ul class="navbar-nav" >
            ...
            <li class="nav-item"><a href="${pageContext.request.contextPath}/myboard/boardlist" class="nav-link">Board</a></li>
            <li class="nav-item"><a href="${pageContext.request.contextPath}/upload/upboardList" class="nav-link">List(Upload)</a></li>
